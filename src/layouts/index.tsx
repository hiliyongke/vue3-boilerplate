...
export default defineComponent({
  ...
  setup() {
    ...
    const getTabRouterListCache = () => {
      tabsRouterStore.initTabRouterList(
        JSON.parse(localStorage.getItem('tabRouterList'))
      );
    };
    ...
    const renderContent = () => {
      ...
      const tabRouters = tabsRouterStore.tabRouters.filter(
        route => route.isAlive || route.isHome
      );
      return (
                  ...
                  v-slots={{
                    label: () => (
                      <t-dropdown
                        ...
                        minColumnWidth={128}
                        popupProps={{
                          overlayClassName: 'router-tabs-dropdown'
                        }}
                        v-slots={{
                          dropdown: () =>
